...
-- 윈도우 > 설정 > 연결 > 연결 유형 AUTO COMMIT BY DEFAULT 체크 해제 되어 있는지 다시 확인
...
-- 테이블에 있는 모든 값을 INSERT 할 때 사용
-- 단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야 함
SELECT * FROM EMPLOYEE2;

INSERT INTO EMPLOYEE2 
VALUES('900', '홍길동', '991215-1234567', 'hong_gd@or.kr', '01011111111', 'D1', 'J7', 'S3', 4300000, 0.2,200, SYSDATE,NULL,'N');
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = '900';
ROLLBACK;


-- 2) INSERT INTO 테이블명(컬럼명 1, 컬럼명2, 컬럼명3...)
-- VALUES (데이터1, 데이터2, 데이터3...)
-- 테이블에 내가 선택한 컬럼에 대한 값만 INSERT 할 때 사용
-- 선택 안된 컬럼은 값이 NULL 이 들어감(DEFAULT 존재시 DEFAULT 설정한 값이 삽입됨)
...
-- 조회 다시 해봄(영구저장 되어서 롤백 해도 되돌리기 안됨)
...
-- * 여러 컬럼을 한번에 수행할 시 콤마(,) 로 컬럼을 구분하면 됨
-- D9 / 총무부 -> D0 / 전략기획팀 변경
...
-- 이를 반영하는 UPDATE 문을 서브쿼리를 이용하여 작성
...
INSERT INTO EMP_M02
VALUES(999,'곽두원','561016-1234567', 'kwack_dw@or.kr', '01011111111', 'D9', 'J4', 'S1', 9000000, 0.5, NULL, SYSDATE, NULL, 'N');
