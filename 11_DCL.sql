 ...
 * 		UPDATE		 TABLE, VIEW
 * 		DELETE		 TABLE, VIEW
 * 		ALTER			 TABLE, SEQUENCE ( 수정권한 - 구조 변환)
...
-- 2. 새 연결(접속) 추가
--CREATE USER kdj_sample IDENTIFIED BY 1234;
--> 접속 권한
...
GRANT CREATE SESSION TO kdj_sample;
...
GRANT CREATE TABLE TO kdj_sample;

ALTER USER kdj_sample DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
GRANT CONNECT, RESOURCE TO kdj_sample;
...
REVOKE SELECT ON EMPLOYEE FROM kdj_sample;
