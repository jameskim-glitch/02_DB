...
COMMENT ON COLUMN "MEMBER".ENDROLL_DATE IS '회원 가입일';

-- MEMBER 테이블에 샘플 데이터 삽입
-- INSERT INTO 테이블명 VALUES (값1, 값2,... )

INSERT INTO "MEMBER" VALUES ('MEM01', '123ABC', '홍길동', '991215-1234657', DEFAULT);

-- * INSERT/UPDATE 시 컬럼 값으로 DEFAULT 작성하면
-- 테이블 생성시 해당 컬럼에 지정된 DEFAULT 값으로 삽입이 된다! *
...
INSERT INTO "MEMBER" VALUES ('MEM02', '456ABC', '김영희', '001215-2234657', SYSDATE);
-- DEFAULT 설정된 컬럼이라고 삽입/수정시 DEFAULT 만 작성해야 하는것 아님
-- 컬럼 테이터 타입에 맞춘 데이터 삽입/수정 가능

SELECT * FROM MEMBER;

--> 가입일 -> INSERT 시 미작성 하는 경우 DEFAULT 값이 반영되는지 확인
-- INSERT INTO 테이블명(컬럼명 1, 컬럼명2) VALUES(값1, 값2)
...
--> 0으로 시작할 가능성이 있으면 CHAR, VARCHAR2 같은 문자열 타입으로 사용
...
1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');


INSERT INTO USER_USED_NN VALUES(
null, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');
...
--USER_ID VARCHAR2(20)  UNIQUE, -- 컬럼레벨(제약 조건명 미지정)
--USER_ID VARCHAR2(20) CONSTANT USER_ID_U UNIQUE  -- 컬럼레벨 (제약 조건명 지정)
USER_ID VARCHAR2(20),
USER_PWD VARCHAR2(20),
USER_NAME VARCHAR2(30),
GENDER VARCHAR2(10),
...
EMAIL VARCHAR2(50),
-- 테이블 레벨
--UNIQUE(USER_ID) -- 테이블레벨 (제약 조건명 미지정)
...
INSERT INTO USER_USED_UK VALUES(
1, NULL, 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');
...
INSERT INTO USER_USED_UK2 VALUES(
1, 'USER02', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');

INSERT INTO USER_USED_UK2 VALUES(
1, 'USER01', 'PASS01', '고길동', '남자', '010-1234-1324', 'hong_gd@or.kr');
...
INSERT INTO USER_USED_PK VALUES(
1, 'USER02', 'PASS02', '이순신', '남자', '010-2222-3333', 'LEE_SS@or.kr');
...
INSERT INTO USER_USED_PK VALUES(
2, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');

SELECT * FROM USER_USED_PK;

----------------------------------------------------------------------------------------
--PRIMARY KEY 복합키(테이블 레벨)
...
EMAIL VARCHAR2(50)
-- 테이블 레벨
, CONSTRAINT PK2_USERNO_USERID PRIMARY KEY(USER_NO, USER_ID));
...
INSERT INTO USER_USED_PK2 VALUES(
1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH.PK2_USERNO_USERID)에 위배됩니다
...
CREATE TABLE USER_USED_FK (
    ...
    USER_ID VARCHAR2(20) UNIQUE, -- 사용자 ID(중복값 허용 X)
    USER_PWD VARCHAR2(20) NOT NULL, -- 사용자 PW(NULL X)
    USER_NAME VARCHAR2(30),
    GENDER VARCHAR2(10),
    PHONE VARCHAR2(30),
    EMAIL VARCHAR2(50),
...
1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1324', 'hong_gd@or.kr', 10);
-- USER_GRADE(부모/참조 테이블)에 10 이라는
-- GRADE_CODE 가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES(
2, 'USER02', 'PASS02', '이순신', '남자', '010-2222-3333', 'lee_ss@or.kr', 10);
-- USER_GRADE(부모/참조 테이블)에 10 이라는
-- GRADE_CODE 가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES(
3, 'USER03', 'PASS03', '유관순', '여자', '010-4444-1111', 'yoo_ks@or.kr', 30);

INSERT INTO USER_USED_FK VALUES(
4, 'USER04', 'PASS04', '안중근', '남자', '010-7777-8888', 'ahn_jk@or.kr', NULL);

INSERT INTO USER_USED_FK VALUES(
5, 'USER05', 'PASS05', '윤봉길', '남자', '010-7777-9999', 'yoon_bg@or.kr', 50);
...
-- GRADE_CODE 중 20은 사용되고 있지 않으므로 삭제가 가능함
...
-- 자식 테이블 (ON DELETE SET NULL 이 적용된 자식 테이블)
...
-- 부모 테이블인  USER_GRADE2 에서 GRADE_CODE 가 10 삭제
--> ON DELETE SET NULL 옵션이 설정되어 있어서
-- 부모키를 참고하고 있는 자식이 NULL 로 변하여
-- 부모키는 오류없이 삭제됨
...
INSERT INTO USER_USED_CHECK VALUES(
1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-1324', 'hong_gd@or.kr');
-- 가능

INSERT INTO USER_USED_CHECK VALUES(
2, 'USER02', 'PASS02', '유관순', '여', '010-4444-1111', 'yoo_ks@or.kr');
-- 가능
